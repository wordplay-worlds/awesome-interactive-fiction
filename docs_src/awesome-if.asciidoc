...
ifdef::IsADoc[link:https://git.io/awesome-if[+++<img src="docs/Awesome-IF.png" align="right" width="400">+++^,title="Awesome Interactive Fiction"]]
 ...
 Customized list highlighting the most relevant interactive fiction frameworks, tools, and resources for wordplay-worlds projects. 
 
 Based on tajmone/awesome-interactive-ficiton by https://github.com/yakiradixon[Yakira Dixon^] in 2014, currently maintained by https://github.com/tajmone[Tristano Ajmone^].
